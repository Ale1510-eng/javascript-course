...
const amdRadeonRx = {
    ...
    dato2: "Descrip 2",
    dato3: "Descrip 3",
    compatibilidad : ["Mother Board 5699", "Mother Board 5656"],
    imprimirPrecioMxN: function(){ return `$${this.price} M.N`},
    imprimirPrecioDolares: function(){ return `$${this.price /20} Dolares`}
 };
